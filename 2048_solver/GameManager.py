...
class GameManager:
    def __init__(self, size=4, intelligentAgent=None, computerAI=None, displayer=None):
        ...
        self.intelligentAgent   = intelligentAgent   or IntelligentAgent(1, 1, 1, 1)
    ...
    def start(self) -> int:
        ...
        # self.grid.map[0][0] = 4
        # self.grid.map[0][1] = 16
        # self.grid.map[0][2] = 64
        # self.grid.map[0][3] = 1024
        # self.grid.map[1][0] = 4
        # self.grid.map[1][1] = 8
        # self.grid.map[1][2] = 32
        # self.grid.map[1][3] = 8
        # self.grid.map[2][0] = 2
        # self.grid.map[2][1] = 0
        # self.grid.map[2][2] = 2
        ...
        # self.grid.map[0][0] = 4
        # self.grid.map[0][1] = 32
        # self.grid.map[0][2] = 128
        # self.grid.map[0][3] = 256
        # self.grid.map[1][0] = 2
        # self.grid.map[1][1] = 8
        # self.grid.map[1][2] = 64
        # self.grid.map[1][3] = 128
        # self.grid.map[2][0] = 4
        # self.grid.map[2][1] = 0
        # self.grid.map[2][2] = 32
        # self.grid.map[2][3] = 64
        # self.grid.map[3][0] = 0
        # self.grid.map[3][1] = 0
        # self.grid.map[3][2] = 8
        # self.grid.map[3][3] = 16
...
def main():
    ...
    #             avg_score = 0
    #             for m in range(5):
    #                 intelligentAgent = IntelligentAgent(0, w2, w3, w4)
    #                 computerAI = ComputerAI()
    #                 displayer = Displayer()
    #                 gameManager = GameManager(4, intelligentAgent, computerAI, displayer)
    #                 max = gameManager.start()
    #                 avg_score += max
    #                 if max > 1024:
    #                     print("HOLY SHIT WE MADE IT!")
    #                     print("Final weights: " + "," + str(w2) + "," + str(w3) + "," + str(w4))
    #                 print("Finished game")
    ...
    #                 w3_final = w3
    #                 w4_final = w4
    #                 print("Updated weights: " + "," + str(w2_final) + "," + str(w3_final) + "," + str(w4_final))
    scores = []
    time_total = time.process_time()
    for i in range(10):
    ...
    for score in scores:
        print(str(score) + ",")
    time_total = time.process_time() - time_total
    print("Total time: " + str(time_total))
    #print("Final weights: " + str(w1_final) + "," + str(w2_final) + "," + str(w3_final) + "," + str(w4_final))
